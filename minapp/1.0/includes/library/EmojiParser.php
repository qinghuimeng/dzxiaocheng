 ...
 * @license   MIT
 * @link      https://github.com/urakozz/php-emoji-parser
 */
...
class EmojiParser
{
    ...
    public function getPattern($delimiter = "/")
    {
        $modifier = $delimiter ? "u" : null;
        $pattern  = sprintf('%s%s%s%s%s%s', $delimiter, $this->prepend, $this->pattern, $this->append, $delimiter, $modifier);
        return $pattern;
    }
