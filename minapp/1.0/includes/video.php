...
class class_video{
	...
	**/
	function youku( $vid ) {	
		...
		$r['url'] = 'http://player.youku.com/embed/'. $json['vidEncoded'] ;
//                $r['url'] = 'http://v.youku.com/v_show/id_'. $json['vidEncoded'] .'.html';
	...
	**/
	function tudou( $vid ) {
		...
		$r['vid'] = $arr['code'];
//               "http://www.tudou.com/programs/view/html5embed.action?type=1&code=r-Z9-je0rOg&lcode=yDAr7mb13L8&resourceId=0_06_05_99"
		$r['url'] = 'http://www.tudou.com/programs/view/html5embed.action?code='. $arr['code'].'&resourceId=0_06_05_99';
...
//		$r['url'] = 'http://v.ku6.com/show/'. $vid .'.html?ref=http://www.lianyue.org/';
                $r['url'] = 'http://v.ku6.com/fetchwebm/'. $vid .'...m3u8';
	...
	**/
	function _56( $vid ) {
		...
		$json = $json['info'];
		$r['vid'] = $json['textid'];
//                http://share.vrs.sohu.com/my/v.swf&topBar=1&id=81713152&autoplay=false&from=page
//                $r['url'] = 'http://tv.sohu.com/upload/static/share/share_play.html#'.$vid.'_'.$json['data']['myTvUid'].'_0_9001_0';
		$r['url'] = 'http://share.vrs.sohu.com/my/v.swf&topBar=1&id='. $json['textid'] .'&autoplay=false&from=page';
	...
	**/
	function qq( $vid ) {
		...
		$r['vid'] = $xml['vid'];
                $r['url'] = 'http://v.qq.com/iframe/player.html?vid='. $xml['vid'];
		$r['swf'] = 'http://v.qq.com/page/t/u/h/'. $xml['vid'] .'.html?ref=lianyue.org';
//		$r['url'] = 'http://static.video.qq.com/TPout.swf?vid='. $xml['vid'] .'&auto=0';
		$r['title'] = $xml['ti'];
	...
	**/
	function letv( $vid ) {
		...
		$r['swf'] = 'http://www.letv.com/ptv/vplay/' . $r['vid'] . '.html';
		$r['url'] = 'http://i7.imgs.letv.com/player/swfPlayer.swf?id='. $r['vid'].'autoplay=0';
		$r['img']['large'] = '';
	...
	**/
	function sohu( $vid ) {
		...
		$r['vid'] = $vid;
		$r['swf'] = $json['url'] . '?ref=lianyue.org';
                $r['url'] = 'http://tv.sohu.com/upload/static/share/share_play.html#'.$vid.'_'.$json['data']['myTvUid'].'_0_9001_0';
//		$r['url'] = 'http://share.vrs.sohu.com/my/v.swf&ref=lianyue.org&id='.$vid;
